...
export default function Dashboard({ profile, workoutPlan, gamification, onSignOut, onRefresh }: Props) {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans" style={{ backgroundColor: '#09090B' }}>
            {/* Top header */}
            <header className="flex items-center justify-between px-5 pt-20 pb-8 safe-top border-b" style={{ backgroundColor: '#09090B', borderColor: 'rgba(255,255,255,0.05)' }}>
            ...
            <main className="flex-1 overflow-y-auto pb-20">
                ...
                <div className="flex justify-center mt-8 mb-4">
                    <span className="text-[10px] text-gray-700 font-semibold tracking-widest uppercase">Versão 1.1.5</span>
                </div>
            </main>
